...
export const checkTurnResourceGain =
    (side: (CombatantInfo | null | undefined)[], context: ActionContext) =>
...
const getResourcesPerTurn = (
    combatantInfo: CombatantInfo,
): { rawResources: number; resources: number } => {
    ...
    const baseResourcesGained = Math.min(
        getMaxResources(combatant) - combatant.resources,
