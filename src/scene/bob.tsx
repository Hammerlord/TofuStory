                    ...
                    next: [
                        {
                            speaker: bob,
                            dialog: [
                                "Hey, man! Thanks for not steamrolling me. It's tough out here being a lowly green snail.",
                            ],
                        },
                        {
                            speaker: bob,
                            ...
                            responses: [
                                {
                                    ...
                                    next: [
                                        ...
                                        },
                                        {
                                            speaker: bob,
                                            dialog: [
                                                "Can't really give you any pointers, but maybe you can find out more in the towns.",
                                            ],
                                            responses: [
                                                {
                                    ...
                                    next: [
                                        {
                                            speaker: bob,
                                            dialog: [
                                                "Well I'll be damned. Bet it's second nature to ya.",
                                            ],
                                        },
                                        {
                                            speaker: bob,
                                            dialog: [
                                                "Some seekers have an easier time of it than others, growing, leveling up.",
                                            ],
                                        },
                                        {
                                            speaker: bob,
                                            dialog: [
                                                "Why'd they give ME the ability to grow if I'm just a damn snail!?",
                                            ],
                                            responses: [
                                                {
                                                    text: "They?",
