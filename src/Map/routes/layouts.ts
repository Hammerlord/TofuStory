...
export const enemyLayouts = {
    ...
    normal: [
        ...
        [null, EASY, HARD, EASY, null],
        [EASY, null, HARD, null, EASY],
    ...
    hard: [
        ...
        [null, HARD, EASY, HARD, null],
        [HARD, null, null, null, HARD],
        [EASY, null, HARDEST, null, EASY],
        [null, null, HARDEST, null, null],
    ] as ENEMY_DIFFICULTY[][],
    hardest: [
        [null, HARD, HARD, HARD, null],
        [null, NORMAL, HARDEST, EASY, null],
        [null, EASY, HARDEST, NORMAL, null],
    ],
};
