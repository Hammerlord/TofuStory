...
import { energyBolt, ignite, magicArmor, magicClaw, tribolt } from "../ability/magician/magicianAbilities";
                            ...
                            conditions: [
                                {
                                    ...
                                    comparator: "eq",
                                    name: [tribolt.name, magicClaw.name, magicArmor.name, ignite.name],
                                },
                            ],
                            removeEffect: true,
                        },
